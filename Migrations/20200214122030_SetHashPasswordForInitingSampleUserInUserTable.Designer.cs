...
namespace IOT.Migrations
{
    ...
    [Migration("20200214122030_SetHashPasswordForInitingSampleUserInUserTable")]
    partial class SetHashPasswordForInitingSampleUserInUserTable
    {
            ...
            modelBuilder.Entity("IOT.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterDate = new DateTime(2020, 2, 14, 15, 50, 29, 956, DateTimeKind.Local).AddTicks(1625),
                            Status = (short)1,
                            Type = 1,
                            Username = "BitBird"
                        });
